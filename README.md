...
2. Open `normalization_tool/normalization_tool/index.html` directly in any standard web browser (Google Chrome, Mozilla Firefox, Microsoft Edge, Brave, Safari).
3. *(Optional)* Use VS Code **Live Server** extension for real-time development reloading.
...
This project is created for academic and educational purposes under the DBMS Innovative Assignment curriculum at CHARUSAT.
